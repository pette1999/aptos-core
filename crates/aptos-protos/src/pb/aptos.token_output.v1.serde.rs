...
impl serde::Serialize for CollectionData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aptos.token_output.v1.CollectionData", len)?;
        if !self.creator_address.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CollectionData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aptos.token_output.v1.CollectionData")
            }
        ...
        deserializer.deserialize_struct("aptos.token_output.v1.CollectionData", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Token {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aptos.token_output.v1.Token", len)?;
        if !self.creator_address.is_empty() {
            struct_ser.serialize_field("creatorAddress", &self.creator_address)?;
        }
        if !self.collection_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Token {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aptos.token_output.v1.Token")
            }
        ...
        deserializer.deserialize_struct("aptos.token_output.v1.Token", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TokenData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aptos.token_output.v1.TokenData", len)?;
        if !self.creator_address.is_empty() {
            struct_ser.serialize_field("creatorAddress", &self.creator_address)?;
        }
        if !self.collection_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for TokenData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aptos.token_output.v1.TokenData")
            }
        ...
        deserializer.deserialize_struct("aptos.token_output.v1.TokenData", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TokenOwnership {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aptos.token_output.v1.TokenOwnership", len)?;
        if !self.creator_address.is_empty() {
            struct_ser.serialize_field("creatorAddress", &self.creator_address)?;
        }
        if !self.collection_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for TokenOwnership {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = TokenOwnership;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aptos.token_output.v1.TokenOwnership")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<TokenOwnership, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut creator_address__ = None;
        ...
        deserializer.deserialize_struct("aptos.token_output.v1.TokenOwnership", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Tokens {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.token_ownerships.is_empty() {
            len += 1;
        }
        ...
        let mut struct_ser = serializer.serialize_struct("aptos.token_output.v1.Tokens", len)?;
        if self.block_height != 0 {
        ...
        if !self.token_ownerships.is_empty() {
            struct_ser.serialize_field("tokenOwnerships", &self.token_ownerships)?;
        }
        if !self.token_datas.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Tokens {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "tokenOwnerships" => Ok(GeneratedField::TokenOwnerships),
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aptos.token_output.v1.Tokens")
            }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut token_ownerships__ = None;
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::TokenOwnerships => {
                            if token_ownerships__.is_some() {
                                return Err(serde::de::Error::duplicate_field("tokenOwnerships"));
                            }
                            token_ownerships__ = Some(map.next_value()?);
                        }
                ...
                Ok(Tokens {
                    ...
                    token_ownerships: token_ownerships__.unwrap_or_default(),
                    token_datas: token_datas__.unwrap_or_default(),
                    collection_datas: collection_datas__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("aptos.token_output.v1.Tokens", FIELDS, GeneratedVisitor)
    }
}
